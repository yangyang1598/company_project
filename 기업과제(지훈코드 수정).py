...
yellow_lower = (110, 135, 120)  # (10, 140, 10)
yellow_upper = (190, 220, 235)  # (30, 190, 40)
...
name = ['WIN_20220101_12_23_10_Pro']
...
while True:
    ...
    img_p = Perspective(img_frame, img_target_location, img_location)
    img_aspart = Perspective(img_p, img_target_location, img_location)
    img_r,img_g,img_b=cv2.split(img_aspart)
    ...
    if (img_r>=50 and img_r<=80) and (img_g>=70 and img_g<=105) and (img_b>=85 and img_b<=125):
        yellow_lower1 = (150, 180, 195)  # (10, 140, 10)
        yellow_lower2 = (110, 135, 120)
        yellow_upper1 = (205, 225, 235)  # (30, 190, 40)
        yellow_upper2 = (145, 165, 190)
        img_mask11 = cv2.inRange(img_p, yellow_lower1, yellow_upper1)
        img_mask12 = cv2.inRange(img_p, yellow_lower2, yellow_upper2)
        img_mask1 = img_mask11+img_mask12
        print("dark")
    elif (img_r>80 and img_r<=105) and (img_g>105 and img_g<=140) and (img_b>125 and img_b<=160):
        yellow_lower1 = (120, 150, 160)  # (10, 140, 10)
        #yellow_lower2 = (80, 110, 120)
        yellow_upper1 = (145, 180, 200)
        #yellow_upper2=(130,155,170)
         # (30, 190, 40)
        img_mask1 = cv2.inRange(img_p, yellow_lower1, yellow_upper1)
        #img_mask12 = cv2.inRange(img_p, yellow_lower2, yellow_upper2)
        #img_mask1 = img_mask11+img_mask12
        print("semi-dark")
    elif (img_r > 105 and img_r <= 135) and (img_g > 135 and img_g <= 165) and (img_b > 160 and img_b <= 180):
        yellow_lower = (150, 170, 180)  # (10, 140, 10)
        yellow_upper = (190, 210, 215)  # (30, 190, 40)
        img_mask1 = cv2.inRange(img_p, yellow_lower, yellow_upper)
        print("semi-light")
    elif (img_r>135 and img_r<=175) and (img_g>165 and img_g<=190) and (img_b>180 and img_b<=200):
        yellow_lower = (170, 180, 190)  # (10, 140, 10)  (110, 135, 145)
        yellow_upper = (190, 210, 220)  # (30, 190, 40)  (160, 175, 175)
        img_mask1 = cv2.inRange(img_p, yellow_lower, yellow_upper)
        print("light")
    else:
        if(img_g>=155):
    ...
    img_yellow = cv2.bitwise_and(img_p, img_p, mask=img_mask1)
    ...
    yellow = cv2.merge([img_canny, img_canny, img_canny])
    # img_p = cv2.pyrDown(img_p)
    cv2.imshow("video", img_frame)
    cv2.imshow("canny", yellow)
    #color_text(img_p, 15)
